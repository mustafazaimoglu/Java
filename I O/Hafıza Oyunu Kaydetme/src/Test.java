...
public class Test
{
    ...
    public static void kayittanAl()
    {
        ...
        if (file.exists())
        {
            System.out.print("Kaydedilmiş bir oyun bulunmakta! kayıttan devam etmek istermisiniz? (yes or no) : ");
    ...
    {       
        ...
        */
        ...
        while (OyunBittiMi() == false)
        {
            ...
            System.out.print("Oyunu Kayıt Etmek İstiyormusuz ? (Yes or No) : ");
            String cevap = scanner.nextLine();
            ...
            //System.out.println("Oyundan Cıkılıyor...");
